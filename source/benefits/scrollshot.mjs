...
const BLOCK = process.argv[5] || 'start';
async function main() {
  ...
  await send('Runtime.evaluate', { expression: `document.querySelector(${JSON.stringify(SELECTOR)}).scrollIntoView({block:${JSON.stringify(BLOCK)}})` });
